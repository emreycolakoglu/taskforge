...
export function EmojiPicker({ value, onChange, className }: EmojiPickerProps) {
  ...
  const emojis = useMemo(() => EMOJI_CATEGORIES[CATEGORY_NAMES[activeCategory]], [activeCategory]);
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-72 p-0" align="start" onCloseAutoFocus={() => setOpen(false)}>
        {/* Category tabs */}
