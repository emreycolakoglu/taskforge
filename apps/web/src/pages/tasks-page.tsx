...
export function TasksPage() {
  ...
  return (
    <div className="h-full overflow-y-auto bg-background space-y-4">
      <header className="flex h-12 items-center gap-2 border-b border-border bg-secondary px-6 shrink-0">
        <SidebarTrigger
            ...
            {results.map((task) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={cn('text-xs font-semibold shrink-0', priorityColor(task.priority))}
                  >
                    {task.priority}
                  </span>
                  {task.status && (
